# -*- coding: utf-8 -*-
"""
Created on Fri Dec  8 15:40:52 2023

@author: sirna

Content:
    data has been quality controlled and purged
    Removes data 4 standard deviations or higher
...
Using this to build the filter point labeled four_std_away
'''
...
four_std_away = mean_concentration_pre + (4*std_dev_concentration_pre)
...
'''
Filter: 4 std away from mean
The filtering condition: if greater than four_std_away removed
'''

master_frame['filtered_concentration'] = master_frame['concentration_scrubbed'] [master_frame['concentration_scrubbed'] < four_std_away]
...
'''
Printing of Statistical changes in data for four standard deviations away filtering
'''
